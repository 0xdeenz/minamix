...
class PayoutOnlyOnce extends SmartContract {
    ...
    @method payout(nullifier: Nullifier) {
        ...
        let nullifierMessage = this.nullifierMessage.getAndAssertEquals();  // APP SPECIFIC -- IDEALLY SET IT TO THE PUBKEY
...
let tx = await Mina.transaction(sender, () => {
    ...
    // SETS THE LOGIC OF THE SMART CONTRACT -- ITS FIXED HERE
